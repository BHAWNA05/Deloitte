...
public class LaunchCustomerApplication {
	...
	{  while(true)
		...
		System.out.println("#### 6.Search all customer greater than billamount ####");
		System.out.println("#### 7.Search customer details by customer address and billamount ####");
		...
		if(choice==6)
		{   System.out.println("Please enter the billamount");
		   int billAmount = scanner.nextInt();
			List<String> allNames = customerDAO.filterCustomer(billAmount);
			
			System.out.println("List of all customer with billamount greater than " + " " + billAmount);
			System.out.println(allNames);
		}
		if(choice==7)
		{   System.out.println("Please enter the billamount");
		   int billAmount = scanner.nextInt();
		   System.out.println("Please enter the customeraddress");
		   String customerAddress = scanner.next();
		
			List<Customer> allNames = customerDAO.filterCustomer(customerAddress, billAmount);
			
			System.out.println("List of all customer with address and billamount: ");
			System.out.println(allNames);
		}
		if(choice==10) {
